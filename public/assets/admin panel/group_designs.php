...
if(isset($_POST['delete'])){
    ...
    $delete_request = $conn->prepare("DELETE FROM `group_designs` WHERE id = ?");
...
if(isset($_POST['update_status'])){
    ...
    $update_status = $conn->prepare("UPDATE `group_designs` SET status = ? WHERE id = ?");
...
<head>
    ...
    <title>Group Design Requests</title>
...
<body>
    ...
    <section class="show-products">
        <h1 class="heading cs_heading">Group Design Requests</h1>
        <div class="box-container">
            <?php
            $select_requests = $conn->prepare("SELECT * FROM `group_designs` ORDER BY created_at DESC");
